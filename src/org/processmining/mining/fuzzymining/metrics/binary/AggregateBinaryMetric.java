...
public class AggregateBinaryMetric extends BinaryMetric {
	 ...
	 * @param aDescription
	 */
	public AggregateBinaryMetric(String name, String description, List<BinaryMetric> componentMetrics) {
	...
	/* (non-Javadoc)
	 * @see org.processmining.mining.fuzzymining.metrics.BinaryMetric#getMeasure(int, int)
	 */
	...
	protected void aggregateMetrics() {
		ArrayList<BinaryMetric> validMetrics = new ArrayList<BinaryMetric>(metrics.size());
		...
		normalized = MatrixUtils.multiplyAllFields(relations.copy(), (normalizationMaximum / aggregateMax));
	}

	/* (non-Javadoc)
	 * @see org.processmining.mining.fuzzymining.metrics.binary.BinaryMetric#isValid()
	 */
