...
public class DistanceSignificanceMetric extends
	...
	public DistanceSignificanceMetric(MetricsRepository aRepository) {
		super("Distance Significance", 
				"Measures significance by the distance in significance of a link with its endpoints.", 
				aRepository);
	}

	/* (non-Javadoc)
	 * @see org.processmining.mining.fuzzymining.metrics.BinaryDerivateMetric#measure()
	 */
	public void measure() {
		AggregateUnaryMetric aggUnaryMetric = repository.getAggregateUnaryLogMetric();
		AggregateBinaryMetric aggBinaryMetric = repository.getAggregateSignificanceBinaryLogMetric();
		// calculate metrics from primary unary and secondary significance metrics
