...
public class MetricsRepository {
	...
	public void apply(LogReader log, Attenuation att, int maxRelationDistance, Progress progress) 
		...
		scanner.scan(log, this, att, maxRelationDistance, progress, currentProgress);
	...
	public AggregateUnaryMetric getAggregateUnaryMetric() {
		if(aggUnaryMetric == null) {
			aggUnaryLogMetric = 
				new AggregateUnaryMetric("Aggregate unary metrics",
	...
	public AggregateUnaryMetric getAggregateUnaryLogMetric() {
		if(aggUnaryLogMetric == null) {
			...
			aggUnaryLogMetric = 
				new AggregateUnaryMetric("Aggregate unary log metrics",
	...
	public AggregateBinaryMetric getAggregateSignificanceBinaryLogMetric() {
		if(aggSignificanceBinaryLogMetric == null) {
			...
			aggSignificanceBinaryLogMetric = 
				new AggregateBinaryMetric("Aggregate binary significance log metrics",
	...
	public AggregateBinaryMetric getAggregateCorrelationBinaryLogMetric() {
		if(aggCorrelationBinaryLogMetric == null) {
			...
			aggCorrelationBinaryLogMetric = 
				new AggregateBinaryMetric("Aggregate binary correlation log metric",
	...
	public AggregateBinaryMetric getAggregateSignificanceBinaryMetric() {
		if(aggSignificanceBinaryMetric == null) {
			...
			aggSignificanceBinaryMetric = 
				new AggregateBinaryMetric("Aggregate binary significance metrics",
	...
	public AggregateBinaryMetric getAggregateCorrelationBinaryMetric() {
		if(aggCorrelationBinaryMetric == null) {
			...
			aggCorrelationBinaryMetric = 
				new AggregateBinaryMetric("Aggregate binary correlation metrics",
