 ...
 *
 */
public class TaskClusterPainter extends Painter {

	/**
	 * @param canvas
	 */
	public TaskClusterPainter(AnimationCanvas canvas) {
		super(canvas);
	...
	public void paint(long modelTime, Graphics2D g2d) {
		...
		List<TaskAnimation> taskAnimations = canvas.getAnimation().getClusterTaskAnimations();
		...
		for(TaskAnimation taskAnimation : taskAnimations) {
			...
			String type = ((ClusterNode)taskAnimation.getNode()).size() + " primitives";//taskAnimation.getEventType();
