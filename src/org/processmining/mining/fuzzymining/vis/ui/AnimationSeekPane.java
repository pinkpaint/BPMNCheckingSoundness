 ...
 *
 */
public class AnimationSeekPane extends JComponent implements AnimationListener, MouseMotionListener, MouseListener {
	...
	protected void paintComponent(Graphics g) {
		...
		RoundRectangle2D.Float clip = new RoundRectangle2D.Float(0f, 0f, (float)width, (float)height, 10f, 10f);
		...
		gradient = new GradientPaint(0, 0, new Color(0, 0, 0, 0), 
				0, height, new Color(0, 0, 0, 60), false);
		g2d.setPaint(gradient);
		g2d.fillRect(0, 0, width + 1, height + 1);
		gradient = new GradientPaint(0, 0, new Color(200, 200, 200, 10), 
				0, waveCenter, new Color(200, 200, 200, 50), false);
		g2d.setPaint(gradient);
		g2d.fillRect(0, 0, width + 1, waveCenter);
		gradient = new GradientPaint(0, waveCenter, new Color(200, 200, 200, 50), 
				0, waveCenter + 3, new Color(200, 200, 200, 0), false);
		g2d.setPaint(gradient);
		...
		int[] handleX = new int[] {handleCenter + 5, handleCenter + 5, handleCenter, handleCenter - 5, handleCenter - 5};
		int[] handleY = new int[] {0, waveCenter + 5, waveCenter + 10, waveCenter + 5, 0};
		gradient = new GradientPaint(0, 0, new Color(200, 200, 200, 0), 
				0, 5, new Color(200, 200, 200, 110), false);
		g2d.setPaint(gradient);
		g2d.fillPolygon(handleX, handleY, 5);
		gradient = new GradientPaint(0, 0, new Color(200, 200, 200, 0), 
				0, 5, new Color(220, 220, 220, 120), false);
		g2d.setPaint(gradient);
	...
	protected void measureActivity() {
		...
		for(int i=0; i<activity.length; i++) {
			activity[i] = this.animation.getActivityBetween(segStart, segStart + step);
			segStart += step;
	...
	public void mousePressed(MouseEvent e) {
		int mouseX = e.getX();
		int handleCenter = hBorder + (int)(this.position * (float)(this.getWidth() - hBorder - hBorder));
