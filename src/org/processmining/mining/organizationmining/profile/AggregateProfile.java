...
public class AggregateProfile extends Profile {
	...
	/* (non-Javadoc)
	 * @see org.processmining.mining.hierachicalorgminer.profile.Profile#getDistanceMatrix(org.processmining.mining.hierachicalorgminer.distance.DistanceMetric)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.processmining.mining.hierachicalorgminer.profile.Profile#getItemKey(int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.processmining.mining.hierachicalorgminer.profile.Profile#getItemKeys()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.processmining.mining.hierachicalorgminer.profile.Profile#getValue(String, int)
	 */
	@Override
	public double getValue(String originatorName, int itemIndex) {
		...
		double value = profile.getValue(originatorName, origItem) * normalizationFactor;
		return value;
	}
	
	/* (non-Javadoc)
	 * @see org.processmining.mining.hierachicalorgminer.profile.Profile#getValue(int, int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.processmining.mining.hierachicalorgminer.profile.Profile#getValue(int, java.lang.String)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.processmining.mining.hierachicalorgminer.profile.Profile#numberOfItems()
	 */
	@Override
