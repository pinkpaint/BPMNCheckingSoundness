...
public interface HierarchicalData extends Iterable<HierarchicalDataElement> {
	...
	String formatNumber(int format, double value); // the given format will be a valid index in the list returned by getAvailableNumberFormats
	List<ModelGraph> graphsToExclude();
	
	// These two functions should return the type of hierarchy as a string. For example: Ontology / Ontologies.
