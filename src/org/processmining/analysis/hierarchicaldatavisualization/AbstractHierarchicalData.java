...
abstract public class AbstractHierarchicalData implements HierarchicalData {
	...
	protected Map<String, ModelGraphVertex> makeOntologyModels(OntologyCollection ontologies) {
	...
	protected Map<String, ModelGraphVertex> makeDefaultModel(String graphName, String rootName, List<String> elements) {
	...
	public DotFormatter getDotFormatter() {
		return new DotFormatter() {
			...
			public Map<String, String> dotFormatEdge(ModelGraph graph, ModelGraphEdge edge) {
				boolean isEdgeToOntologyNode = false; // TODO edge.getSource().inDegree() == 0;
				
				Map<String, String> result = new HashMap<String, String>();
				result.put("style", "filled");
				result.put("color", isEdgeToOntologyNode ? "gray" : "black");
				result.put("arrowtail", isEdgeToOntologyNode ? "none" : "normal");
				result.put("arrowhead", "none");
				result.put("label", "");
				return result;
			}

			public Map<String, String> dotFormatVertex(ModelGraph graph, ModelGraphVertex vertex) {
