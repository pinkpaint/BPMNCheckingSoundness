...
/**
 * Data class encapsulating the type of a difference between 
 * events at a given global position. 
 * 
...
public class EventDiff {
	...
	public enum DiffType {
		...
		right // additional event on right side
	}
	...
	/**
	 * Creates an event difference object based on the given traces and diff info. 
	 * @param leftTrace the event in the 'from' trace in the comparison (may be null)
	 * @param rightTrace the event in the 'to' trace in the comparison (may be null)
	 * @param leftDiffed whether there is an original event in the left trace that is 
	 * part of a difference (if <code>false</> then either no difference
	 * or right-diffed at this position)
	 * @param rightDiffed whether there is an original event on the right side that is 
	 * part of a difference (if <code>false</> then either no difference
	 * or left-diffed at this position)
	 * @param leftInd the index of the audit trail entry in the original left trace 
	 * (-1 if no original event is mapped to this position)
	 * @param rightInd the index of the audit trail entry in the original right trace 
	 * (-1 if no original event is mapped to this position)
	 */
