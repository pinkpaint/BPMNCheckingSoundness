...
public class RedesignNode extends GGNode {
    ...
    private static GGNodePainter painter = new RedesignNodePainter(background, border, text);
    /**
     ...
     */ 
     ...
     /** 
      * Flag for indicating whether the model performs better than the original model. 
      */ 
     ...
     /**
      * Flag for indicating whether the model performs in the best class of models. 
      */ 
      ...
      /** 
       * Flag for indicating whether the model performs the same as the original model. 
       */ 
       protected boolean isEqualPerforming = false;
        
      /**         
       * Flag for indicating whether the model performs worse than the original model. 
       */ 
       protected boolean isWorsePerforming = false;
      
       /**
        * Flag for indicating whether the model performs in the worst class of models. 
        */ 
        ...
        protected boolean isWorstFourthPerforming = false;
          ...
          * @param model HLPetriNet the associated model
    ...
    * <p>Used by event listeners, not for end user consideration. 
    */ 
     ...
     */ 
     ...
     /**
      * Returns the mean of the selected performance indicator. Obtained through simulation.
     ...
     /** 
      * Sets the 95% confidence interval including mean of the selected performance indicator. 
      * <p>Used by event listeners, not for end user consideration. 
      */ 
