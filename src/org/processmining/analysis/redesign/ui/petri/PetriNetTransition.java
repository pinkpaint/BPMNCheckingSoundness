...
public class PetriNetTransition extends GGNode {
    ...
    private static GGNodeShapePainter painter = new PetriNetTransitionPainter(background, border, text);

	private Transition original;

	/** 
     * NB. indicating whether a node is selected: isSelected(), 
     * is handled in super. 
     */ 
    ...
    /** 
     * Flag for indicating that the selected node cannot be included in the
     * same component as the selected node(s) is(are). 
     */ 
	...
	/** 
	 * Probes, whether this node is currently selected and included in a component. 
	 */ 
	 ...
	 /** 
	  * Probes, whether the node could be included in the same 
      * component as the selected node(s) is(are).
      */
	  ...
	  /** 
	   * Sets whether the node could be included in the same 
	   * component as the selected node(s) is(are).
	   * <p>Used by event listeners, not for end user consideration. 
	   */ 
	  ...
	  /** 
	   * Probes, whether the node cannot be included in the same 
	   * component as the selected node(s) is(are).
	   */ 
	  ...
	  /** 
	   * Sets whether the node cannot be included in the same 
	   * component as the selected node(s) is(are).
	   * <p>Used by event listeners, not for end user consideration. 
	   */ 
