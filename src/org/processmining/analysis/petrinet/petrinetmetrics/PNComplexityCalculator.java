...
public class PNComplexityCalculator implements AnalysisPlugin {
	...
	public String getHtmlDescription() {
		...
		String header = "Plugin made by João Sobrinho and Daniel Teixeira on University of Madeira (http://www.uma.pt) to analyse Complexity of Business Processes modeled in Petri Nets.";
