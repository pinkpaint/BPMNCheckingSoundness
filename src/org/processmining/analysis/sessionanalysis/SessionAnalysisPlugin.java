...
public class SessionAnalysisPlugin implements AnalysisPlugin {
	...
	public JComponent analyse(AnalysisInputItem[] inputs) {
		...
		return new SessionAnalysisResult(logReader, this);
	}
	...
	public String getHtmlDescription() {
		return "http://prom.win.tue.nl/research/wiki/sessionanalysis";
	}
