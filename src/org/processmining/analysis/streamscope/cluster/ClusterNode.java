...
public class ClusterNode extends Node {
	...
	public int[] getIndices() {
		if(indices == null) {
			...
			Arrays.sort(indices);
			//System.out.println("updated indices for " + name + ": " + minIndex + " > " + maxIndex);
			//System.out.print("[");
	...
	/* (non-Javadoc)
	 * @see org.processmining.analysis.streamscope.cluster.Node#distance(org.processmining.analysis.streamscope.cluster.Node, org.processmining.analysis.streamscope.cluster.Distance)
	 */
	@Override
