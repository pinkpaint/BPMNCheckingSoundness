...
{	
	...
	{	
		...
		for (int i = 0; i < hmm.nbStates(); i++) {
			...
			if (i < observationMapping.size()) {
				logEventString = " (" + observationMapping.get(i).getModelElementName() + ")";
			} 
	 ...
	 */
	public void write(H hmm, String filename, ArrayList<LogEvent> observationMapping) throws IOException
	{
