...
/**
 * Precision and Structure metrics based on the Minimal Description Length principle. 
 * Advocates a balance of the cost of encoding the model and encoding the data with the model. 
 * <br>
 * Different encodings are possible in the case that the event log does not fit, e.g., the 
 * given process model. 
 * 
