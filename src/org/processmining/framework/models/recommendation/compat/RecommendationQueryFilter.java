...
/**
 * This class provides a wrapper around a ProM log filter, which enables it
 * to be applied to recommendation queries as well.
 *
...
public class RecommendationQueryFilter {
	 ...
	 * @param aFilter the log filter to be wrapped
	 */
	...
	/**
	 * Filters the audit trail inside a recommendation query with the
	 * wrapped log filter. This method modifies the recommendation query
	 * parameter itself!
	 * @param aQuery recommendation query to be filtered
